...
The web service is containerized(https://hub.docker.com/r/gplates/gws). Users can choose to deploy the service on their servers/personal computers if they need enhanced performance and data security. The instructions on how to set up On-Prem hosting can be found at https://gwsdoc.gplates.org/on-prem-hosting.
