...
**E1**: Reconstruct two coordinates((lon:95,lat:54)(lon:142,lat:-33)) back to 140 million years ago using the "SETON2012" reconstruction model. The function returns the reconstructed coordinates in the valid GeoJSON format. [Available Reconstruction Models](https://github.com/GPlates/gplates_web_service_doc/wiki/Reconstruction-Models) 
